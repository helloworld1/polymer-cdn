...
```
https://cdn.rawgit.com/helloworld1/polymer-cdn/1.4.0/lib/my-cool-element/my-cool-element.html
```
...
## Contents
All the libraries available in polymer-cdn can be found side-by-side in the [lib](https://github.com/helloworld1/polymer-cdn/tree/1.4.0/lib) subfolder. 
...
polymer-cdn#1.4.0 /tmp/polymer-cdn
├─┬ carbon-elements#0.1.0
│ └─┬ carbon-route#0.8.4
│   ├── iron-location#0.8.1
│   └── polymer#1.4.0
├─┬ gold-elements#1.0.1
│ ├─┬ gold-cc-cvc-input#1.0.7
...
│ │ │ │ └── polymer#1.4.0
│ │ │ ├── polymer#1.4.0
│ │ │ └── web-animations-js#2.1.4 (latest is 2.2.0)
│ │ └── polymer#1.4.0
│ ├─┬ iron-fit-behavior#1.0.6
│ │ └── polymer#1.4.0
│ ├─┬ iron-flex-layout#1.3.1
...
│ │ │ └── polymer#1.4.0
│ │ └── polymer#1.4.0
│ ├─┬ iron-page-url#0.7.3 (latest is 0.8.1)
│ │ └── polymer#1.4.0
│ ├─┬ iron-pages#1.0.7
│ │ ├─┬ iron-resizable-behavior#1.0.3
│ │ │ └── polymer#1.4.0
